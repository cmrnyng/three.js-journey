...
bloomGUI.add(unrealBloomPass, "strength", 0, 2, 0.001);
bloomGUI.add(unrealBloomPass, "radius", 0, 2, 0.001);
bloomGUI.add(unrealBloomPass, "threshold", 0, 1, 0.001);
...
const tintGUI = gui.addFolder("Tint");
tintGUI
...
displacementGUI.add(displacementPass, "enabled");
